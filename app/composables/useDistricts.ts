...
export const districts: District[] = [
  {
    number: '01', name: 'Meraki Studio', subtitle: 'The Production House', slug: 'voight-studio',
    image: '/images/districts/voight-studio.webp', type: 'Production & Commercial', layout: 'hero',
  ...
  {
    number: '02', name: 'Meraki Publishing House', subtitle: 'The Editorial Voice', slug: 'the-road',
  ...
  {
    number: '03', name: 'Meridian', subtitle: 'The Compass', slug: 'meridian',
  ...
  {
    number: '05', name: 'The Provenance', subtitle: 'The Vault', slug: 'the-provenance',
  ...
  {
    number: '06', name: 'Basecamp', subtitle: 'The Hearth', slug: 'basecamp',
  ...
  {
    number: '07', name: 'Common Ground', subtitle: 'The Forum', slug: 'common-ground',
  ...
  {
    number: '08', name: 'The Pavilion Store', subtitle: 'Merchandise & Meraki Mint', slug: 'the-mint',
    image: '/images/districts/the-mint.webp', type: 'Commerce & Limited Editions', layout: 'wide',
    description: 'Ethical monetization infrastructure for independent creators.',
    longDescription: 'The Pavilion Store is commerce infrastructure built for creators who take their independence seriously. Fair revenue splits, transparent pricing, ethical monetization tools\u2014everything a creator needs to build a sustainable practice without compromising their values or ceding control to platforms that don\u2019t share their interests.',
  ...
  {
    number: '09', name: 'The Seal', subtitle: 'The Standard', slug: 'the-seal',
  ...
  {
    number: '10', name: 'The Collective', subtitle: 'The Alliance', slug: 'the-collective',
  ...
  {
    number: '11', name: 'The Frame', subtitle: 'The Lens', slug: 'the-frame',
  ...
  {
    number: '12', name: 'Meraki Fashion Atelier', subtitle: 'The Fashion House', slug: 'fashion-atelier',
    image: '/images/districts/fashion-atelier.webp', type: 'Fashion & Design', layout: 'wide',
    description: 'Design, production, and presentation of fashion collections rooted in creative culture.',
    longDescription: 'Meraki Fashion Atelier is the fashion house of Meraki Road. Design, production, and presentation of fashion collections rooted in creative culture. Every collection is conceived as a creative statement\u2014an intersection of material craft, visual identity, and the cultural conversations that shape how we present ourselves to the world.',
    pullQuote: 'Fashion as creative statement, rooted in culture and craft.',
    offerings: ['Collection design', 'Production oversight', 'Fashion presentations', 'Creative collaboration'],
    status: 'development',
    accentColor: '#9B6B8A', accentColorAccessible: '#7D5470', fontVariation: "'WONK' 1, 'SOFT' 50, 'opsz' 48",
  },
]
