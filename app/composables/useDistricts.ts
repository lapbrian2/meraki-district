...
export const districts: District[] = [
  {
    number: '01', name: 'Voight Studio', subtitle: 'The Foundry', slug: 'voight-studio',
  ...
  {
    number: '02', name: 'The Road', subtitle: 'The Chronicle', slug: 'the-road',
  ...
  {
    number: '04', name: 'Fieldwork', subtitle: 'The Expedition', slug: 'fieldwork',
  ...
  {
    number: '08', name: 'The Mint', subtitle: 'The Atelier', slug: 'the-mint',
