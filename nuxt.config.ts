...
export default defineNuxtConfig({
  ...
  app: {
    head: {
      ...
      meta: [
        { name: 'description', content: 'A cultural ecosystem for AI-native creators who refuse to choose between ambition and integrity. Ten quarters. One district. A new standard for creative practice.' },
        { name: 'viewport', content: 'width=device-width, initial-scale=1' },
        { property: 'og:title', content: 'Meraki District \u2014 Where craft meets culture' },
        { property: 'og:description', content: 'A cultural ecosystem for AI-native creators. Ten quarters. One district. A new standard for creative practice.' },
        ...
        { name: 'twitter:description', content: 'A cultural ecosystem for AI-native creators. Ten quarters. One district.' },
        { name: 'theme-color', content: '#09090B' },
        { property: 'og:site_name', content: 'Meraki District' },
        { property: 'og:locale', content: 'en_US' },
        { property: 'og:image', content: (process.env.NUXT_PUBLIC_SITE_URL || 'https://meraki-district.vercel.app') + '/images/hero-bg.webp' },
        { property: 'og:image:width', content: '1200' },
        { property: 'og:image:height', content: '630' },
        { name: 'twitter:image', content: (process.env.NUXT_PUBLIC_SITE_URL || 'https://meraki-district.vercel.app') + '/images/hero-bg.webp' },
      ],
      link: [
